...
import { random, randomInt } from './MathUtils';

/**
 * Generate a grass texture using HTML Canvas
 * @returns The generated grass texture
 */
 ...
 * @returns The generated brick texture
 */
 ...
 * @returns The generated wood texture
 */
 ...
 * @returns The generated marble texture
 */
export function createMarbleTexture(): THREE.Texture {
  const canvas = document.createElement('canvas');
  canvas.width = 256;
  canvas.height = 256;
  const ctx = canvas.getContext('2d');
